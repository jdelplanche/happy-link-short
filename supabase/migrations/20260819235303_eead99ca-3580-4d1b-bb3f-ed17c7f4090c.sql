...
-- ---------- Short links on top of tracked codes ----------
ALTER TABLE public.tracked_qrs
  ADD COLUMN IF NOT EXISTS kind text NOT NULL DEFAULT 'qr',
  ADD COLUMN IF NOT EXISTS short_link_enabled boolean NOT NULL DEFAULT false;

ALTER TABLE public.custom_domains
  ADD COLUMN IF NOT EXISTS short_links_enabled boolean NOT NULL DEFAULT false;

CREATE INDEX IF NOT EXISTS tracked_qrs_user_kind_idx ON public.tracked_qrs (user_id, kind);